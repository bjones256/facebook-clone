-- USERS
-- insert into users (first_name, last_name, email, profile_img, phone)
-- values ('Brian','Jones','bjones256@gmail.com','https://lh3.googleusercontent.com/-PryN-1AfACs/Th4l6jpI9tE/AAAAAAAABbs/SD1GOySRk6QjlqfduXqFvjU4num52yQ_QCEwYCg/w326-h220-p/ProfilePhotos', '256-394-9988'),
-- ('Billy','Wilson','b.wilson@gmail.com','http://voyagedallas.com/wp-content/uploads/2017/12/personal_photo-80-1000x600.jpg', '123-456-7890'),
-- ALTER TABLE users
...
-- CONNECTIONS
-- insert into connections (requester_id,requestee_id,is_active,status)
-- values (1,2,true,'accepted')

-- POSTS
-- insert into posts (user_id,text_content,img,created_at)
